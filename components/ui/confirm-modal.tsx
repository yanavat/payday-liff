...
export function ConfirmModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
      <div className="w-full max-w-[400px] rounded-lg bg-white p-6 shadow-modal">
        ...
        {hasReasonInput && (
          <label className="mt-4 block">
            ...
            />
            {!reasonValid && <span className="mt-1 block text-caption text-red-600">กรุณาระบุอย่างน้อย 10 ตัวอักษร</span>}
          </label>
        )}
        <div className="mt-6 flex justify-end gap-2">
          ...
          <button
            ...
            onClick={() => onConfirm(hasReasonInput ? reason.trim() : undefined)}
            className={cn(
              ...
              variant === 'primary' ? 'bg-primary hover:bg-primary-dark' : 'bg-red-600 hover:bg-red-700',
            )}
          >
