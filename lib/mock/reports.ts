...
const seededRand = (seed: number, max: number, min = 0) =>
  min + Math.floor((Math.sin(seed * 9301 + 49297) * 0.5 + 0.5) * (max - min));

// 30 days of daily disbursement data for May 2025
export const dailyDisbursements: DailyDisbursement[] = Array.from(
  { length: 31 },
  (_, i) => {
    const day = i + 1;
    ...
    return {
      ...
      amount: isWeekend ? 0 : seededRand(i, 50000, 10000),
      count: isWeekend ? 0 : seededRand(i + 100, 15, 3),
    };
  },
);
...
export const weeklyDisbursements = Array.from({ length: 52 }, (_, i) => ({
  week: `W${i + 1}`,
  amount: seededRand(i + 200, 100000, 20000),
  count: seededRand(i + 300, 30, 5),
}));
...
export const reconciliationItems: ReconciliationItem[] = [
  {
    ...
    amount: 3000,
    status: "processing",
    attemptedAt: "2025-05-14T12:00:00",
  },
  {
    ...
    amount: 5000,
    status: "settled",
    attemptedAt: "2025-05-13T15:00:00",
    settledAt: "2025-05-13T15:30:00",
  },
  {
    ...
    amount: 1500,
    status: "settled",
    attemptedAt: "2025-05-10T14:00:00",
    settledAt: "2025-05-10T14:45:00",
  },
  {
    ...
    amount: 1500,
    status: "failed",
    attemptedAt: "2025-05-08T14:00:00",
    failureReason: "ชื่อบัญชีไม่ตรงกัน",
  },
  {
    ...
    amount: 8000,
    status: "settled",
    attemptedAt: "2025-05-13T10:00:00",
    settledAt: "2025-05-13T10:30:00",
  },
];
