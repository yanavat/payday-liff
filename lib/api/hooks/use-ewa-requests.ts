...
export function usePreviewEWARequest() {
  ...
  const preview = async (data: PreviewRequestDto): Promise<PreviewResultDto | null> => {
    try {
      setLoading(true)
      setError(null)
...
export function useEWARequestActions() {
  ...
  const create = async (data: CreateRequestDto): Promise<EWARequestDto | null> => {
    try {
      setLoading(true)
      setError(null)
  ...
  const createOnBehalf = async (data: OnBehalfRequestDto): Promise<EWARequestDto | null> => {
    try {
      setLoading(true)
      setError(null)
  ...
  const approve = async (id: string): Promise<EWARequestDto | null> => {
    try {
      setLoading(true)
      setError(null)
  ...
  const reject = async (id: string, data?: RejectRequestDto): Promise<EWARequestDto | null> => {
    try {
      setLoading(true)
      setError(null)
  ...
  const disburse = async (id: string): Promise<EWARequestDto | null> => {
    try {
      setLoading(true)
      setError(null)
